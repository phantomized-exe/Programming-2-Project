...
def draw():
    ...
    if debug:
        ...
        pygame.draw.rect(window, (0, 0, 255), left, 2)
        pygame.draw.rect(window, (0, 0, 255), right, 2)
        pygame.draw.rect(window, (0, 0, 255), left2, 2)
        pygame.draw.rect(window, (0, 0, 255), right2, 2)
    if cheat:
        player.jump_count = 0
def check_crouch():
    global CROUCH_FRICTION
...
left = Player()
left.x = player.standing_x
left.y = player.standing_y+2
left.height = player.height-4
left.width = 2
right = Player()
right.x = player.standing_x+player.width-2
right.y = player.standing_y+2
right.height = player.height-4
right.width = 2
left2 = Player()
